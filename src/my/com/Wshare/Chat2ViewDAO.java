...
public class Chat2ViewDAO {
	static Connection currentCon = null;
	static ResultSet rs = null;

	public String getChat2(Chat2ViewBean bean) {
		Statement stmt = null;
...
//				String current_name = rs.getString("current_name");
				...
				list += "<div class=\"bttn-containerH\" id=\"bttn-container\" name=\"filter\" value=\""+User_name+"\">";
				list += "<div class=\""+User_name+"\" id=\"test\">";
			...
			System.out.println("getChat2 failed: An Exception has occurred! " + ex);
		}
