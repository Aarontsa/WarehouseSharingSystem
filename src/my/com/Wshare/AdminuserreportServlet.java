...
import my.com.Wshare.AdminuserreportDAO;
//import my.com.bbraun.hrit.EvaluationForm.Sanitizer;

import com.google.gson.Gson;

public class AdminuserreportServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			AdminuserreportDAO AdminuserreportDAO = new AdminuserreportDAO();

			/*** Convert the result to JSON format and return to the UI ***/
			String bean = AdminuserreportDAO.getuserReportDetails();
