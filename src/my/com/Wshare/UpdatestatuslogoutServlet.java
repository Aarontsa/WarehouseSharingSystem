...
import my.com.Wshare.UpdatestatuslogoutBean;
import my.com.Wshare.UpdatestatuslogoutDAO;
import my.com.Wshare.Sanitizer;


//@WebServlet("/HomeServlet")
public class UpdatestatuslogoutServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;
//	private HomeDAO home = new HomeDAO();
	public UpdatestatuslogoutServlet() {
		super();
	}
...
//			Float longtitudeS=Float.parseFloat(request.getParameter("longtitude"));
			System.out.println("logout status"+User_Status);
...
//			String clean_CPasswordsS = new Sanitizer().sanitize(CPasswordsS);
			...
			UpdatestatuslogoutBean bean = new UpdatestatuslogoutBean();
...
//			bean.SetlongtitudeS(longtitudeS);
			...
			bean = UpdatestatuslogoutDAO.selectQuery(bean);
