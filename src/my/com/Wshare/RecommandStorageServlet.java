...
import my.com.Wshare.RecommandStorageBean;
import my.com.Wshare.RecommandStorageDAO;
import my.com.Wshare.Sanitizer;

//@WebServlet("/HomeServlet")
public class RecommandStorageServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;

	public RecommandStorageServlet() {
		super();
	}
...
//			/*** Pass the bean to DAO for processing ***/
	        RecommandStorageDAO RecommandStorageDAO = new RecommandStorageDAO();

			/*** Convert the result to JSON format and return to the UI ***/
			String bean = RecommandStorageDAO.getRecommandStorage();
