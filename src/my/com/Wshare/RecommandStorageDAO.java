...
public class RecommandStorageDAO {
	static Connection currentCon = null;
	static ResultSet rs = null;

	public String getRecommandStorage() {
		Statement stmt = null;
...
//				String User_Description = rs.getString("User_Description");
				...
				list += "<div id=\"" + User_id + "-"+timelooping+"\" class=\"bttn-container\" value=\"" + User_id + "\" name=\"filter\">";
...
//				list += "</div>";
			...
			System.out.println("getRecommandStorage failed: An Exception has occurred! " + ex);
		}
